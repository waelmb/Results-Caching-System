...
def scrape_news_page(news_url,driver):
    ...
    article_url = ''
    text = ''
    article_sec = soup.find('div',class_='article__body')
...
def write_lst(lst,file_):
    with open(file_,'w') as f:
        f.write('\n'.join(lst))
dir_url = 'https://www.webmd.com/news/default.htm' #url of home page
...
article_urls_file = '../webmd_urls.txt'
articles_file = '../webmd_articles.txt'
